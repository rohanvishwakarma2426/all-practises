import{d as decodeString16,m as mojoTimeTicks,a as assert,s as skColorToRgba,I as I18nBehavior,h as hasKeyModifiers,b as mojoTimeDelta,c as mojoString16,W as WindowProxy,E as EventTracker,N as NewTabPageProxy,$ as $$,M as ModuleHeight,r as recordOccurence,e as recordLoadDuration,f as recordPerdecage,g as ModuleRegistry,i as assertNotReached,j as strictQuery,F as FocusOutlineManager,k as recordVoiceAction,A as Action,l as hexColorToSkColor,B as BrowserCommandProxy,C as CustomizeDialogPage}from"./shared.rollup.js";export{$ as $$,B as BrowserCommandProxy,o as ChromeCartProxy,C as CustomizeDialogPage,D as DriveProxy,v as InfoDialogElement,w as InitializeModuleCallback,x as Module,y as ModuleDescriptor,z as ModuleDescriptorV2,G as ModuleHeaderElement,M as ModuleHeight,g as ModuleRegistry,N as NewTabPageProxy,P as PhotosProxy,T as TaskModuleHandlerProxy,A as VoiceAction,Q as VoiceError,W as WindowProxy,p as chromeCartDescriptor,q as chromeCartV2Descriptor,O as createScrollBorders,d as decodeString16,t as driveDescriptor,u as driveV2Descriptor,c as mojoString16,H as photosDescriptor,K as recipeTasksDescriptor,J as recipeTasksV2Descriptor,n as recordDuration,e as recordLoadDuration,r as recordOccurence,f as recordPerdecage,L as shoppingTasksDescriptor}from"./shared.rollup.js";import{PolymerElement,html,mixinBehaviors,microTask}from"chrome://resources/polymer/v3_0/polymer/polymer_bundled.min.js";import{PageHandler,PageCallbackRouter}from"chrome://new-tab-page/realbox.mojom-webui.js";import"chrome://new-tab-page/strings.m.js";import{loadTimeData}from"chrome://resources/js/load_time_data.m.js";import"chrome://resources/mojo/url/mojom/url.mojom-webui.js";import{DoodleShareChannel,DoodleImageType}from"chrome://new-tab-page/new_tab_page.mojom-webui.js";import"chrome://resources/mojo/skia/public/mojom/skcolor.mojom-webui.js";import{Command}from"chrome://resources/js/browser_command/browser_command.mojom-webui.js";import"chrome://resources/js/cr.m.js";import"chrome://new-tab-page/chrome_cart.mojom-webui.js";import"chrome://resources/mojo/mojo/public/mojom/base/string16.mojom-webui.js";import"chrome://resources/mojo/mojo/public/mojom/base/time.mojom-webui.js";import"chrome://new-tab-page/drive.mojom-webui.js";import"chrome://new-tab-page/photos.mojom-webui.js";import"chrome://new-tab-page/task_module.mojom-webui.js";// Copyright 2020 The Chromium Authors. All rights reserved.
...
:host-context(ntp-realbox-match[has-image]) #image {
  display: initial;
}fsdhfuihduig reqinhdttumm'9umn n
...
nkdbsbf  ,;po<mok;ns d      bsdfdbjijv
\vvfdfedf
bhjsbuydfb n gttiobkjmn s
hnjsdkhfuisdnbyrfd
jhiofmf
  hhiuiufghsdufmdnjfb 
  dhdsihfijsd   
...
<!--_html_template_end_-->`}static get properties(){return{title:String,url:Object}}onFacebookClick_(){const url="https://www.facebook.com/dialog/share"+`?app_id=${FACEBOOK_APP_ID}`+`&href=${encodeURIComponent(this.url.url)}`+`&hashtag=${encodeURIComponent("#GoogleDoodle")}`;WindowProxy.getInstance().open(url);this.notifyShare_(DoodleShareChannel.kFacebook)}onTwitterClick_(){const url="https://twitter.com/intent/tweet"+`?text=${encodeURIComponent(`${this.title}\n${this.url.url}`)}`;WindowProxy.getInstance().open(url);this.notifyShare_(DoodleShareChannel.kTwitter)}onEmailClick_(){const url=`mailto:?subject=${encodeURIComponent(this.title)}`+`&body=${encodeURIComponent(this.url.url)}`;WindowProxy.getInstance().navigate(url);this.notifyShare_(DoodleShareChannel.kEmail)}onCopyClick_(){this.$.url.select();navigator.clipboard.writeText(this.url.url);this.notifyShare_(DoodleShareChannel.kLinkCopy)}onCloseClick_(){this.$.dialog.close()}notifyShare_(channel){this.dispatchEvent(new CustomEvent("share",{detail:channel}))}}customElements.define(DoodleShareDialogElement.is,DoodleShareDialogElement);// Copyright 2020 The Chromium Authors. All rights reserved.
